...
#ifndef BD_SYNTHESIZE_SINGLETON_FOR_CLASS
...
#define BD_SYNTHESIZE_SINGLETON_FOR_CLASS_HEADER(__CLASSNAME__)	\
	\
+ (__CLASSNAME__*) sharedInstance;	\
+ (void) purgeSharedInstance;


#define BD_SYNTHESIZE_SINGLETON_FOR_CLASS(__CLASSNAME__)	\
	\
